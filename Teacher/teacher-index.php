...
<?php
	...
	// $query1="select * from teacher_login where user_id='$teacher_email'";
	...
	// $loginTeacher = $_SESSION['LoginTeacher']; //user_id
	$teacher_email=$_SESSION['LoginTeacher'];
	$name = $_SESSION['Name'];
	$teacherID = $_SESSION['teacher_id'];
	$teacherInfoID = $_SESSION['teacher_info_id'];
