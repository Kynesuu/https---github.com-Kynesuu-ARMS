...
<?php 
 ...
 if(isset($_POST["btnlogin"]))
 {
        ...
        // teacher_login / admin_login / student_login / registrar login
        $query="select * from registrar_login where user_id='$username' && Password='$password' ";
    ...
    <body class="login-background">
        ...
        <div class="login-div mt-3 rounded">
            ...
            <div class="login-padding">
                <h2 class="text-center text-white">REGISTRAR LOGIN</h2>
                <form class="p-1" action="registrar-login.php" method="POST">
