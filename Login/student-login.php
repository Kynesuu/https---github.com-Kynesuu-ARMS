...
<?php 
 ...
 if(isset($_POST["btnlogin"]))
 {
        ...
        // teacher_login / admin_login / student_login
        $query="select * from student_login where user_id='$username' && Password='$password' ";
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($row=mysqli_fetch_array($result)) {
                ...
                $_SESSION['ID'] = $row['ID'];
                $_SESSION['student_info_id'] = $row['student_info_id'];
