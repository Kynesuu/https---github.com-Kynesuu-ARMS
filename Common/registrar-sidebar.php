  <div class="row w-100">
    ...
    <nav id="sidebarMenu" class="">
        ...
        <div class="sidebar-header">
          <div class="nav-item">
              <a class="nav-link text-white" href="../Registrar/registrar-index.php">
        ...
        -->
          <li class="nav-item">
            <a class="nav-link" href="../registrar/registrar-courses.php">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#">
              ...
              <i class="fa fa-file-text-o mr-2" aria-hidden="true"></i> Reports
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="registrar-transcript.php">
              <span data-feather="layers"></span>
               <i class="fa fa-clock-o mr-2" aria-hidden="true"></i> Academic Records
            </a>
		  </li>
          <li class="nav-item">
            <a class="nav-link" href="#">
              <span data-feather="layers"></span>
              <i class="fa fa-users mr-2" aria-hidden="true"></i> Graduating Students
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../registrar/registrar-teacher-salary.php">
              <span data-feather="layers"></span>
          ...
          <li class="nav-item">
            ...
            -->
          <li class="nav-item">
            <a class="nav-link" href="../registrar/registrar-student-fee.php">
              <span data-feather="layers"></span>
