...
<?php include('../common/student-sidebar.php') ?> 
    <div class="container mt-4">
        <div class="text-danger text-center m-auto">
            <img src="../Images/ucclogo.png" alt="" width="100" height="100">
            <h4 class="text-dark mt-3">UNIVERSITY OF CALOOCAN CITY</h4>
            <h4 class="text-dark">COMPUTER SCIENCE DEPARTMENT - CSD</h4>
        </div>
    </div>
    <div class="container-fluid mb-4 text-dark">
        <div class="program-info">
            <?php  
                ...
                $query = "select * from student_info inner join sessions on sessions.session=student_info.session where student_info.roll_no = '$roll_no'";
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                <?php
                                    $que="select * from student_courses sc inner join sessions s on sc.session = s.session_id";
                                ...
                                <?php
                                    ...
                                    $que="select * from course_subjects where subject_code = '1' and semester=1 order By semester asc";
                                    $run=mysqli_query($con, $que);
                                    while ($row=mysqli_fetch_array($run)) {
                                        $gpa = "";
                                        $grade = "";
                        ...
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                <?php
                                    ...
                                    $quality_points = 0;
                                    $total_quality_points = 0;
                                    $que="select * from course_subjects where subject_code='1' and semester=2 order By semester asc";
                                    $run=mysqli_query($con,$que);
                                    while ($row=mysqli_fetch_array($run)) {
                                        $gpa = "";
                                        $grade = "";
                        ...
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                <?php
                                    ...
                                    $quality_points = 0;
                                    $total_quality_points = 0;
                                    $que="select * from course_subjects where subject_code='1' and semester=3 order By semester asc";
                                    $run=mysqli_query($con,$que);
                                    while ($row=mysqli_fetch_array($run)) {
                                        $gpa = "";
                                        $grade = "";
                        ...
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                <?php
                                    ...
                                    $quality_points = 0;
                                    $total_quality_points = 0;
                                    $que="select * from course_subjects where subject_code='1' and semester=4 order By semester asc";
                                    $run=mysqli_query($con,$que);
                                    while ($row=mysqli_fetch_array($run)) {
                                        $gpa = "";
                                        $grade = "";
                        ...
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                <?php
                                    ...
                                    $quality_points = 0;
                                    $total_quality_points = 0;
                                    $que="select * from course_subjects where subject_code='1' and semester=5 order By semester asc";
                                    $run=mysqli_query($con,$que);
                                    while ($row=mysqli_fetch_array($run)) {
                                        $gpa = "";
                                        $grade = "";
                        ...
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                <?php
                                    ...
                                    $quality_points = 0;
                                    $total_quality_points = 0;
                                    $que="select * from course_subjects where subject_code='1' and semester=6 order By semester asc";
                                    $run=mysqli_query($con,$que);
                                    while ($row=mysqli_fetch_array($run)) {
                                        $gpa = "";
                                        $grade = "";
                        ...
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                <?php
                                    ...
                                    $quality_points = 0;
                                    $total_quality_points = 0;
                                    $que="select * from course_subjects where subject_code='1' and semester=7 order By semester asc";
                                    $run=mysqli_query($con,$que);
                                    while ($row=mysqli_fetch_array($run)) {
                                        $gpa = "";
                                        $grade = "";
                        ...
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                <?php
                                    ...
                                    $quality_points = 0;
                                    $total_quality_points = 0;
                                    $que="select * from course_subjects where subject_code='1' and semester=8 order By semester asc";
                                    $run=mysqli_query($con,$que);
                                    while ($row=mysqli_fetch_array($run)) {
                                        $gpa = "";
                                        $grade = "";
                        ...
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                <?php
                                    ...
                                    $quality_points = 0;
                                    $total_quality_points = 0;
                                    $que="select * from course_subjects where subject_code='1' and semester=9 order By semester asc";
                                    $run=mysqli_query($con,$que);
                                    while ($row=mysqli_fetch_array($run)) {
                                        $gpa = "";
                                        $grade = "";
                        ...
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                <?php
                                    ...
                                    $quality_points = 0;
                                    $total_quality_points = 0;
                                    $que="select * from course_subjects where subject_code='1' and semester=10 order By semester asc";
                                    $run=mysqli_query($con,$que);
                                    while ($row=mysqli_fetch_array($run)) {
                                        $gpa = "";
                                        $grade = "";
